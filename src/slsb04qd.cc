...
Solution of discrete-time Sylvester equations.
Uses SLICOT SB04QD by courtesy of NICONET e.V.
<http://www.slicot.org>
...
DEFUN_DLD (slsb04qd, args, nargout, "Slicot SB04QD Release 5.0")
{
